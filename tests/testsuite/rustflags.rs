...
#[cargo_test]
fn command_line_rustflag() {
    let p = project().file("src/lib.rs", "").build();

    p.cargo("build -v")
        .masquerade_as_nightly_cargo(&["rustflags"])
        .arg("-Zunstable-options")
        .arg("--rustflag=-Cinstrument-coverage")
        .with_stderr(
            "\
[COMPILING] foo v0.0.1 ([..])
[RUNNING] [..]-Cinstrument-coverage[..]
[FINISHED] dev [unoptimized + debuginfo] target(s) in [..]
",
        )
        .run();
...
#[cargo_test]
fn command_line_rustflag_multiple() {
    let p = project().file("src/lib.rs", "").build();

    p.cargo("build -v")
        .masquerade_as_nightly_cargo(&["rustflags"])
        .arg("-Zunstable-options")
        .arg("--rustflag=-Cstrip=debuginfo")
        .arg("--rustflag=-Cinstrument-coverage")
        .with_stderr(
            "\
[COMPILING] foo v0.0.1 ([..])
[RUNNING] [..]-Cinstrument-coverage -Cstrip=debuginfo[..]
[FINISHED] dev [unoptimized + debuginfo] target(s) in [..]
",
        )
        .run();
...
#[cargo_test]
fn command_line_rustflag_with_dependency() {
    Package::new("bar", "0.1.0")
        .file(
            "src/lib.rs",
...
#[cargo_test]
fn command_line_rustflag_build_script() {
    let p = project()
        .file(
            "Cargo.toml",
            r#"
...
#[cargo_test]
fn command_line_rustflag_proc_macro() {
    let p = project()
        .file(
            "Cargo.toml",
            r#"
    ...
    p.cargo("build -v")
        ...
        .arg("-Zunstable-options")
        .arg("--rustflag=-Cinstrument-coverage")
        .with_stderr_contains("[RUNNING] `rustc --crate-name foo [..] -Cinstrument-coverage[..]")
        .run();
}

#[cargo_test]
fn command_line_rustflag_proc_macro_dependency() {
...
#[cargo_test]
fn command_line_rustflag_workspace() {
    let p = project()
        .file(
            "Cargo.toml",
            r#"
...
#[cargo_test]
fn command_line_rustflag_multiple_artifacts() {
    let p = project()
    ...
    p.cargo("test -v")
        ...
        .with_stderr_unordered(
            "\
[COMPILING] foo v0.0.1 ([..])
[RUNNING] `rustc --crate-name foo [..] --crate-type lib [..] -Cinstrument-coverage[..]
[RUNNING] `rustc --crate-name foo src/lib.rs [..] --test [..] -Cinstrument-coverage[..]
[RUNNING] `rustc --crate-name bin1 [..] --test [..] -Cinstrument-coverage[..]
[RUNNING] `rustc --crate-name foo src/main.rs [..] --test [..] -Cinstrument-coverage[..]
[RUNNING] `rustc --crate-name example [..] -Cinstrument-coverage[..]
[FINISHED] test [..]
[RUNNING] [..]
[RUNNING] [..]
[RUNNING] [..]
...
#[cargo_test]
fn command_line_rustflag_cross_compile() {
